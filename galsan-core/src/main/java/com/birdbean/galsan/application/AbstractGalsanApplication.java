 ...
 */
@Slf4j
public abstract class AbstractGalsanApplication extends ControllerApplication {

    private static final Logger log = LoggerFactory.getLogger(AbstractGalsanApplication.class);

    protected final Injector injector;

    protected AbstractGalsanApplication(){
